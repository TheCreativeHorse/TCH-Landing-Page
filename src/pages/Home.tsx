...
const Home: React.FC = () => {
    ...
    return (
        <div className="flex flex-col">
            {/* Hero Section */}
            <section className="bg-white py-12 md:py-24 lg:py-32 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        {/* Left Content */}
                        <div className="relative z-10 text-center lg:text-left">
                            {/* Main Headline */}
                            <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 leading-tight text-gray-900">
                                Are your service calls consistent every week?
                            </h1>

                            {/* Subheadline */}
                            <p className="text-lg md:text-2xl text-gray-600 mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
                                If some weeks are packed and others are slow, you are not alone. There is a more predictable way to generate inbound jobs.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                ...
                                >
                                    Book a 15 Minute Strategy Call <ArrowRight size={18} className="ml-2" />
                                </Button>
                            </div>
                        </div>

                        {/* Right Gradient Visual - Hidden on mobile */}
            ...
            {/* The Problem */}
            <section id="problem" className="py-16 md:py-28 bg-neutral-light">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h2 className="text-3xl md:text-5xl font-heading font-bold text-gray-900 mb-6">Most service businesses do great work.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 my-12 max-w-2xl mx-auto">
                        <div className="p-6 md:p-8 bg-white rounded-2xl border border-green-200 flex items-center justify-center flex-col shadow-sm">
                            <CheckCircle className="text-green-500 mb-4" size={32} />
                            <p className="text-lg font-semibold text-gray-900">Some weeks are full.</p>
                        </div>
                        <div className="p-6 md:p-8 bg-white rounded-2xl border border-red-200 flex items-center justify-center flex-col shadow-sm">
                            <div className="w-8 h-8 rounded-full border-2 border-red-400 flex items-center justify-center mb-4">
            ...
            {/* What I Build */}
            <section id="what-i-build" className="py-16 md:py-28 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 md:mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-heading font-bold text-gray-900 mb-6">What I Build</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        {[
                            ...
                            <div key={index} className="bg-neutral-light p-6 md:p-8 rounded-2xl border border-gray-200 hover:shadow-md hover:border-gray-300 transition-all">
                                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-primary-blue to-primary-sky rounded-xl flex items-center justify-center mb-6 text-white">
                                    <item.icon size={20} className="md:w-6 md:h-6" strokeWidth={2} />
                                </div>
                    ...
                    <div className="text-center mt-12">
                        <p className="text-base md:text-lg font-medium text-primary-navy flex items-center justify-center gap-3">
                            <GrowingGraph />
            ...
            <section id="how-it-works" className="py-16 md:py-32 bg-neutral-light overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16 md:mb-20">
                        <div className="text-center lg:text-left">
                            ...
                            <h2 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-gray-900 mb-6 lg:mb-8 leading-tight">
                                How It Works
                            </h2>
                            <div className="space-y-6 text-lg md:text-xl text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
                                ...
                                <p className="p-6 bg-white rounded-2xl border-l-4 border-primary-blue italic shadow-sm text-left">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:gap-6 relative">
                            ...
                            {[
                                ...
                                <div key={i} className="group p-6 md:p-8 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all relative overflow-hidden text-left">
                                    <div className="flex gap-4 md:gap-6 items-start relative z-10">
                                        <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary-blue to-primary-sky text-white flex items-center justify-center font-bold text-lg md:text-xl shadow-lg ring-4 ring-blue-50">
                                            {step.icon}
                                        </div>
                                        <div>
                                            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 group-hover:text-primary-blue transition-colors">
                                                {step.title}
                                            </h3>
                    ...
                    <div className="pt-12 border-t border-gray-200">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-base md:text-lg font-semibold">
                                <span className="flex items-center gap-2 text-gray-900">
                                    <CheckCircle size={18} className="text-primary-blue" /> No marketing jargon
                                </span>
                                <span className="flex items-center gap-2 text-gray-900">
                                    <CheckCircle size={18} className="text-primary-blue" /> No long contracts
                                </span>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
                        <div className="w-full md:w-1/2 text-center md:text-left">
                            ...
                            <h2 className="text-3xl md:text-5xl font-heading font-bold text-gray-900 mb-6">Mustafa Petti</h2>
                            ...
                            <Button
                                variant="tertiary"
                                className="text-gray-900 hover:text-gray-600 p-0 mx-auto md:mx-0"
                        ...
                        <div className="w-full md:w-1/2">
                            <div className="bg-neutral-light p-8 md:p-10 rounded-2xl border border-gray-200">
                                <h3 className="text-xl font-semibold mb-6 text-gray-900 text-center md:text-left">The approach is simple</h3>
                                <ul className="space-y-4 md:space-y-5">
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-gray-700 text-base md:text-lg">Understand the business</span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-gray-700 text-base md:text-lg">Build structured acquisition systems</span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-gray-700 text-base md:text-lg">Measure performance consistently</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section className="py-16 md:py-28 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10 md:mb-12">
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-gray-900 mb-6 leading-tight">
                            Ready to make your weeks more predictable?
                        </h2>
                        <p className="text-lg md:text-2xl text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                            ...
                            <div className="lg:col-span-2 p-6 md:p-12 bg-neutral-light border-b lg:border-r border-gray-200 text-center lg:text-left">
                                ...
                                {/* Meeting Title */}
                                <h3 className="text-xl md:text-3xl font-heading font-bold text-gray-900 mb-4">
                                    Ready to make your weeks more predictable?
                                </h3>
